...
Then, AFTER the Team Comparison, output COACHABLE MOMENTS: the individual plays worth reviewing, drawn from the Decision Events logged in the segments above. Give TWELVE to TWENTY of them in CHRONOLOGICAL ORDER by timestamp, spread evenly across the whole game rather than clustered in one stretch, and covering BOTH teams. Aim for roughly one every two to three minutes of footage — if your timestamps show a gap of more than five minutes, you skipped a stretch and should go back for it.

GRADE HONESTLY, NOT GENEROUSLY: this is film study, not a highlight reel. The coachable value is in the mistakes. A representative game has a real spread — some A's, plenty of B's and C's, and the D's and F's that actually cost possessions. If nearly everything you output is an A, you selected only good plays and skipped the teaching moments; go back and include the poor decisions logged in the evidence. Walk through the game start to finish: your first card should come from early footage and your last from near the end. Prioritise the uploader's own moments when they appear in the evidence. Each one is a real logged decision — never invent a play. Use this exact format for each:
...
Sport: ${sport || "the sport being played"}
Decision Grade: [A+ / A / A- / B+ / B / B- / C+ / C / C- / D / F for THIS decision]

What Happened:
[One specific sentence about this play.]

Decision Read:
[Talk directly to this player as their coach — were they early, late, did they see it?]

Best Alternative:
[The better read, and why the timing mattered.]

Why It Was Better:
[One tactical sentence.]

Other Options:
- [Realistic option with brief outcome]
- [Another realistic option]

Pattern To Improve:
[Frame it as a habit, not a one-off.]

Practice Focus:
[One drill doable ALONE with no equipment: name it, exact reps, and the one cue.]
=== END ===
`;
